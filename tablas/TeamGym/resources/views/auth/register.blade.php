                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sexo" type="text" class="form-control{{ $errors->has('sexo') ? ' is-invalid' : '' }}" name="sexo" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="modalidad" type="text" class="form-control{{ $errors->has('modalidad') ? ' is-invalid' : '' }}" name="modalidad" value="{{ old('modalidad') }}" required autofocus>
